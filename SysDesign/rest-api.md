...
例如`http://bos.bj.baidubce.com/v1/example`的ETag对应的是example的Object列表，而`http://bos.bj.baidubce.com/v1/example?configuration`的ETag对应的是example的配置。
...
###<span id="error_code">9.7.1 公共错误码（Error Code）</span>
